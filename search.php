...
if(isset($_POST['h_search'])){
   ...
   $h_location = filter_var($h_location, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $h_type = $_POST['h_type'];
   $h_type = filter_var($h_type, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $h_offer = $_POST['h_offer'];
   $h_offer = filter_var($h_offer, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $h_min = $_POST['h_min'];
   $h_min = filter_var($h_min, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $h_max = $_POST['h_max'];
   $h_max = filter_var($h_max, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $min = $_POST['min'];
   $min = filter_var($min, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $max = $_POST['max'];
   $max = filter_var($max, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $status = $_POST['status'];
