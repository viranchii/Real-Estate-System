...
if(isset($_POST['update'])){
   ...
   $property_name = filter_var($property_name, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $price = $_POST['price'];
   $price = filter_var($price, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $deposite = $_POST['deposite'];
   $deposite = filter_var($deposite, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $address = $_POST['address'];
   $address = filter_var($address, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $offer = $_POST['offer'];
   $offer = filter_var($offer, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $type = $_POST['type'];
   $type = filter_var($type, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $status = $_POST['status'];
   $status = filter_var($status, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $furnished = $_POST['furnished'];
   $furnished = filter_var($furnished, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $bhk = $_POST['bhk'];
   $bhk = filter_var($bhk, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $bedroom = $_POST['bedroom'];
   $bedroom = filter_var($bedroom, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $bathroom = $_POST['bathroom'];
   $bathroom = filter_var($bathroom, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $balcony = $_POST['balcony'];
   $balcony = filter_var($balcony, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $carpet = $_POST['carpet'];
   $carpet = filter_var($carpet, FILTER_SANITIZE_FULL_SPECIAL_CHARS); 
   $age = $_POST['age'];
   $age = filter_var($age, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $total_floors = $_POST['total_floors'];
   $total_floors = filter_var($total_floors, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $room_floor = $_POST['room_floor'];
   $room_floor = filter_var($room_floor, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $loan = $_POST['loan'];
   $loan = filter_var($loan, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   $description = $_POST['description'];
   $description = filter_var($description, FILTER_SANITIZE_FULL_SPECIAL_CHARS);

   if(isset($_POST['lift'])){
      $lift = $_POST['lift'];
      $lift = filter_var($lift, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $lift = 'no';
   }
   if(isset($_POST['security_guard'])){
      $security_guard = $_POST['security_guard'];
      $security_guard = filter_var($security_guard, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $security_guard = 'no';
   }
   if(isset($_POST['play_ground'])){
      $play_ground = $_POST['play_ground'];
      $play_ground = filter_var($play_ground, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $play_ground = 'no';
   }
   if(isset($_POST['garden'])){
      $garden = $_POST['garden'];
      $garden = filter_var($garden, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $garden = 'no';
   }
   if(isset($_POST['water_supply'])){
      $water_supply = $_POST['water_supply'];
      $water_supply = filter_var($water_supply, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $water_supply = 'no';
   }
   if(isset($_POST['power_backup'])){
      $power_backup = $_POST['power_backup'];
      $power_backup = filter_var($power_backup, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $power_backup = 'no';
   }
   if(isset($_POST['parking_area'])){
      $parking_area = $_POST['parking_area'];
      $parking_area = filter_var($parking_area, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $parking_area = 'no';
   }
   if(isset($_POST['gym'])){
      $gym = $_POST['gym'];
      $gym = filter_var($gym, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $gym = 'no';
   }
   if(isset($_POST['shopping_mall'])){
      $shopping_mall = $_POST['shopping_mall'];
      $shopping_mall = filter_var($shopping_mall, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $shopping_mall = 'no';
   }
   if(isset($_POST['hospital'])){
      $hospital = $_POST['hospital'];
      $hospital = filter_var($hospital, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $hospital = 'no';
   }
   if(isset($_POST['school'])){
      $school = $_POST['school'];
      $school = filter_var($school, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $school = 'no';
   }
   if(isset($_POST['market_area'])){
      $market_area = $_POST['market_area'];
      $market_area = filter_var($market_area, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   }else{
      $market_area = 'no';
   }

   $old_image_01 = $_POST['old_image_01'];
   $old_image_01 = filter_var($old_image_01, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $old_image_02 = filter_var($old_image_02, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $old_image_03 = filter_var($old_image_03, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $old_image_04 = filter_var($old_image_04, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $old_image_05 = filter_var($old_image_05, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
